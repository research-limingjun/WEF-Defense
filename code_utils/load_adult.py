...
def get_train_test(dataset_dir='adult_datasets/adult.csv', train_dir='adult_datasets/adult.data', test_dir='adult_datasets/adult.test', train_test_ratio=0.8):
...
if __name__ =='__main__':
	...
	print(dirname)
	train_data, train_labels, test_data, test_labels = get_train_test(dataset_dir='../data/adult_datasets/adult.csv', train_dir='../data/adult_datasets/adult.data', test_dir='../data/adult_datasets/adult.test')
